...
@section('content')
    ...
    <table class="table table-bordered table-dark">
        ...
        <tr>
            ...
            <td>{{$key->episodes}}</td>
            <td>{{$key->IMDB}}</td>
            <td width="5"><a href="{{route('actiondetail')}}"><button class="btn btn-primary">Detay</button></a></td>
            <td width="5"><a href="{{route('actionDelete',['id'=>$key->id])}}"><button class="btn btn-primary">Sil</button></a></td>
