    ...
    <table class="table table-bordered table-dark">
        ...
        @foreach($dramas as $key)
            <tr>
                ...
                <td>{{$key->episodes}}</td>
                <td>{{$key->IMDB}}</td>
                <td width="5"><a href="{{route('dramadetail')}}"><button class="btn btn-primary">Detay</button></a></td>
                <td width="5"><a href="{{route('dramaDelete',['id'=>$key->id])}}"><button class="btn btn-primary">Sil</button></a></td>
            </tr>
