...
<head>
    ...
    <title>@yield('title','DiziRehberi')</title>
...
<!-- Page Header -->
<header class="masthead" style="background-image: url('{{asset('front/')}}/img/tv2.jpg')">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Diziease</h1>
                    <span class="subheading">NEKŞFLİX YADA BAŞKA BİŞEY</span>
                </div>
            </div>
        </div>
    </div>
