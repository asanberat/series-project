    ...
    <table class="table table-bordered table-dark">
        ...
        @foreach($scifi as $key)
            <tr>
                ...
                <td>{{$key->episodes}}</td>
                <td>{{$key->IMDB}}</td>
                <td width="5"><a href="{{route('scifidetail')}}"><button class="btn btn-primary">Detay</button></a></td>
                <td width="5"><a href="{{route('scifiDelete',['id'=>$key->id])}}"><button class="btn btn-primary">Sil</button></a></td>
            </tr>
